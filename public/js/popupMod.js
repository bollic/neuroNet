...
L.Popup.include({
   ...
   _onSaveButtonClick: function (e) {
     // 1. Recupera il nuovo contenuto
     const newContent = this._inputField.innerHTML;
     ...
     // 4. Triggera l'evento personalizzato (aggiunto questa parte)
     if (this._source) {
         this._source.fire('popupcontentchanged', { 
             popup: this,
